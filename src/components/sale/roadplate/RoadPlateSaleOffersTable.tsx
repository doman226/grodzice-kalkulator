...
export default function RoadPlateSaleOffersTable({
  ...
  const [copyOffer, setCopyOffer]       = useState<RoadPlateSaleOffer | null>(null);
  ...
  async function handleDownloadPDF(offer: RoadPlateSaleOffer, lang: PdfLang = 'pl') {
    const key = `${offer.id}-${lang}`;
    setPdfLoading(key);
    try {
      const blob = await pdf(<RoadPlateSaleOfferPDF offer={offer} lang={lang} />).toBlob();
  ...
  function handleOfferCopied(created: RoadPlateSaleOffer) {
                        ...
                        <div className="space-y-3">
                          ...
                          <div className="flex justify-between pt-2 border-t border-blue-200">
                            ...
                            <div className="flex gap-2">
                              ...
                              {/* Kopiuj — otwiera modal edycji w trybie copy (nowy numer SPP/YYYY/NNN) */}
                              <button
