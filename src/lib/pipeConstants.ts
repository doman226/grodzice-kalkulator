...
export const PIPE_NORM_DESCRIPTIONS: Record<PipeNorm, string> = {
  ...
  'EN10217-3':   'Rury stalowe do urządzeń ciśnieniowych ze stali stopowych drobnoziarnistych',
...
export const PIPE_NORM_GRADES: Record<PipeNorm, readonly string[]> = {
  ...
  'EN10217-3':   ['P275NL1', 'P275NL2', 'P355N', 'P355NH', 'P355NL1', 'P355NL2'],
...
export const PIPE_NORM_DESCRIPTIONS_EN: Record<PipeNorm, string> = {
  ...
  'EN10217-3':   'Steel pipes for pressure equipment from alloy fine-grain steels',
